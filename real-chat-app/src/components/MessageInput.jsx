    ...
    return (
        <form onSubmit={handleSubmit} className='w-[100%] flex justify-center items-center gap-5 mt-2'>
            <label gfh className='input input-bordered my-2 py-2 px-4 rounded-none flex items-center gap-2'>
                <input className='grow md:w-[20vw] rounded' type="text"placeholder='Escreva sua mensagem' required value={value} onChange={(e) => setValue(e.target.value)} />
            </label>
            <button className='btn shadow'>Enviar</button>
        </form>
    )
}
